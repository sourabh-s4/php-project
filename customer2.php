...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO customer2 (orderdate, company, owner, item, quantity, weight, shipment, trackingid, size, count, specs, checklist) VALUES ('$orderdate', '$company', '$owner', '$item', '$quantity', '$weight', '$shipment', '$trackingid', '$size', '$count', '$specs', '$checklist')";
